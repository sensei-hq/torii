...
begin;
  ...
  insert into catalog.chains(tenant_id, id, name, capability_id, max_fallback_attempts,
  ...
  insert into catalog.chain_bindings(tenant_id, capability, chain_id, space_id, role_id) values
