...
// the sentry shape to the real runtime). Upstream fix tracked at jerrythomas/kavach#25 (publish
// @kavach/* with dist/*.d.ts + extension-ful imports); drop this stub + the `paths` entries once it lands.
