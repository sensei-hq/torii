...
// apps already consume them via vite. Upstream packaging bug (see docs/code-review.md H1); this
// keeps `bun run test` green without vendoring or a global-link dependency.
