...
<div class="rounded-lg border border-paper-edge bg-paper-soft p-6 {cls}">
	<div class="mb-2.5 text-xs font-medium uppercase tracking-widest text-ink-mute">{label}</div>
