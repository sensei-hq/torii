              ...
              return (
                <React.Fragment key={s.id || i}>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    {planeOf(s) === 'local'
                      ? <span className="exec exec-local" style={{ flexShrink: 0 }}><Icon name="models" size={12} tone="success" />on device</span>
                      : <span className="exec" style={{ flexShrink: 0 }}><Icon name="globe" size={12} tone="mute" />gateway</span>}
                  </div>
                </React.Fragment>
              );
            })}
    ...
    return (
      <div className="view-pad wide rise">
        ...
        <PageHeader eyebrow="Workflows" chip={ws} title="Workflows"
          ...
          actions={<span className="pill" style={{ color: 'var(--accent)', background: 'var(--accent-soft)', borderColor: 'oklch(0.58 0.15 35 / 0.28)' }}><Icon name="spark" size={13} tone="accent" /> v2 preview</span>} />
