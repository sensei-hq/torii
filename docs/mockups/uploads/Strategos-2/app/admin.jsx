  ...
  function SettingsView() {
    ...
    return (
      <div className="view-pad rise">
        ...
        <div className="mono" style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', color: 'var(--ink-faint)', marginTop: 'var(--space-5)' }}>Strategos · gateway v2.4 · daemon running · last heartbeat 2s ago</div>
      </div>
    );
  }
