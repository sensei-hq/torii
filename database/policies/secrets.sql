...
alter table core.tenant_key_archive enable row level security;  -- V4: superseded DEKs
...
revoke all on core.tenant_key_archive from anon, authenticated, public;
...
grant select, insert, update, delete on core.tenant_key_archive to service_role;
