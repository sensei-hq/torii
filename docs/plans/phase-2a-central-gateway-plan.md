...
monorepo/
  ...
  services/gateway/
    Cargo.toml
    .env.example                   # DATABASE_URL, SUPABASE_JWKS_URL, PORT, TORII_KEK (local-dev), <PROVIDER>_API_KEY
    src/
