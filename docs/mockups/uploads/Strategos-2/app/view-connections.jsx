    ...
    return (
      <div className="view-pad rise">
        <PageHeader eyebrow="Connections" title="Provider connections"
          sub="The gateway routes every call through Northwind's own credentials. Keys live in the org vault — members never see or handle them. Billing and data residency stay inside your accounts."
          actions={<Pill icon="keys">{connected} of {ROUTERS.length} connected</Pill>} />
