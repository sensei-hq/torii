...
(function () {
  ...
  const WORKFLOWS = [
    WF('wf-renewal', 'Renewal notice — draft & route', 'leasing', {
      ...
      flow: [
        { id: 's1', type: 'retrieve', title: 'Pull tenant record + schedule', detail: 'tenant-4b.json · renewals-schedule.csv' },
    ...
    WF('wf-reconcile', 'Reconciliation → board summary', 'finance', {
      ...
      flow: [
        { id: 's1', type: 'tool', title: 'Query the finance warehouse', detail: 'service-charge actual vs budget', tool: 'warehouse' },
    ...
    WF('wf-classify', 'Auto-classify & route new uploads', 'shared', {
      ...
      cls: 'internal', owner: 'a.rao',
      flow: [
        { id: 's1', type: 'retrieve', title: 'Read parsed content', detail: 'md · csv · json artifacts' },
        { id: 's2', type: 'classify', title: 'Detect PII → set classification', detail: 'public / internal / confidential' },
    ...
    WF('wf-agent', 'Portfolio insights agent', 'leasing', {
      ...
      trace: [
        ...
        { type: 'tool', title: 'Queried warehouse for overruns', detail: 'service-charge variance', tool: 'warehouse' },
